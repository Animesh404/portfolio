...
const AboutSection = (props) => {
    const { setSection } = props
    return (<Section mobileTop>
        <h1 className="text-4xl md:text-6xl font-extrabold leading-snug mt-8 md:mt-0">
            Hi, I'm
        <br />
        <span className="bg-white px-1 italic">Animesh Kumar Jha</span>
        </h1>
        ...
        >
            I make websites and build Robots
        <br />
    ...
    return (
        <Section>
            <motion.div className="w-full" whileInView={"visible"}>
                ...
                <div>
                <h2 className="text-3xl md:text-5xl font-bold mt-8 text-white">Languages</h2>
                <div className="mt-8 space-y-4">
                    {languages.map((lng, index)=> (
                        <div className="w-full md:w-64" key={index}>
                            ...
                            <div className="h-2 w-full bg-gray-200 rounded-full mt-2">
                                <motion.div
                                className="h-full bg-indigo-500 rounded-full" style={{width: `${lng.level}%`}} 
                                initial={{
                                    scaleX: 0,
                                    originX: 0,
                                }}
...
const ContactSection = () => {
    const [state, handleSubmit] = useForm("xzblonjg");
    return (
      <Section>
