...
Command: npx gltfjsx@6.2.14 public/models/scene.glb -K -k 
*/
...
export function Model(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="CharacterSpot" position={[-0.27, 0.25, -0.69]} rotation={[3.071, 0.732, -3.095]}>
          <group name="Armature">
        ...
        <group name="keyboard" position={[0.014, 0.984, -1.304]} rotation={[0, -0.276, 0]} scale={0.667}>
        ...
        <mesh name="Comp_Mouse" geometry={nodes.Comp_Mouse.geometry} material={materials['lambert3SG.003']} position={[-0.215, 0, 0.039]} rotation={[0.001, -0.041, -0.005]} />
        ...
        <group name="Chair" position={[-0.278, -0.015, -0.708]} rotation={[0, -0.376, 0]}>
        ...
        <group name="Plane" position={[0.226, 0, 0]}>
